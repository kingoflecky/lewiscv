const Education = () => {
  return (
    <>
      ...
      <ul>
        <li>
          Identified a lesser-researched topic to independently research.
          Following this I produced a final honours project studying the
          intricate link between the effects of climate change in the Arctic and
          international security.
        </li>
        <li>
          Built great working relationships with faculty staff and peers alike.
          Used the opportunity to learn as much as possible, in turn really fine
          tuning my professional and academic skillsets.
        </li>
        <li>
...
<br/>
      ...
      <ul>
        ...
        <li>
          Was at the forefront of building a support network and made lasting
          connections with peers and tutors.
        </li>
        <li>
          Learnt the fundamentals of how to be a great software engineer from a
          group of top engineers who became tutors.{" "}
        </li>
      </ul>
    </>
  );
